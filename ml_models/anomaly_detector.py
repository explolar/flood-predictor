...
class FloodAnomalyDetector:
    ...
    def detect_from_monthly_stats(self, monthly_df):
        ...
        feature_cols = [
            c
            for c in ["mean_backscatter", "std_backscatter", "min_backscatter", "flood_fraction"]
    ...
    def detect_from_sar_timeseries(self, aoi_json, start_year=2018, end_year=2024, polarization="VH"):
        """
