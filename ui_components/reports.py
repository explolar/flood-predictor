...
def generate_index_pdf_bytes(index_key, index_data, aoi_coords, date_start, date_end):
    ...
    try:
        ...
        pdf.cell(0, 10, f'{index_key} — {meta["label"]}', ln=True)

        pdf.set_font('Helvetica', '', 8)
        pdf.set_text_color(120, 120, 120)
        pdf.cell(0, 5, f'Source: {meta["source"]}   |   Period: {date_start} to {date_end}   |   Formula: {meta["formula"]}', ln=True)
        ...
        pdf.multi_cell(0, 5.5, meta['info'])
        pdf.ln(3)
